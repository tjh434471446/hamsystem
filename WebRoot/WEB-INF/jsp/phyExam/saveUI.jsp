...
<!--表格-->
<s:form id="addPhyExamForm" action="phyExam_add" method="post" namespace="/">
<!-- 计数 -->
...
<!-- <tr> -->
<!-- <td><input type="text" name="" placeholder="日期格式：1970-01-01"/></td> -->
<!-- <td><input type="text" name="" placeholder="日期格式：1970-01-01"/></td> -->
...
<tr>
<td colspan="5" class="tbhead">家庭病床史</td></tr>
<tr class="head-td" >
<td>建床日期</td>
<td>撤床日期</td>
<td>原 因</td>
