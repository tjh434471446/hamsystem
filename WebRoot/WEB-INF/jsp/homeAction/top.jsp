...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">社区居民健康档案管理系统</font> 
		...
		<div id="Head1Right">
			...
			<div id="Head1Right_UserSetup">
            	<a target="right" href="${pageContext.request.contextPath}/userSet_editUI.action"><img border="0" width="13" height="14" src="${pageContext.request.contextPath}/style/images/top/user_setup.gif" /> 个人设置</a>
			</div>
        ...
        <div id="Head1Right_Button">
           <!--  <a target="desktop" href="C:\Users\wujingnan\Desktop"><img width="65" height="20" alt="显示桌面" src="${pageContext.request.contextPath}/style/blue/images/top/desktop.gif" /></a> -->
        </div>
	</div>
        ...
        <div id="Head2_Awoke">
            <ul id="AwokeNum">
                ...
                <li><a href="#" target="right">
                		...
                		提醒（<span id="wait" class="taskListSize"></span>）
                	</a>
                </li>
                <li class="Line"></li>
